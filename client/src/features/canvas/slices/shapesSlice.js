...
export const { addCircle, addLine,  endLine, updateCircle, deleteShape, changeLinewidth, changeColor, select, updateLine, undo, redo, addshape, clearshape, release } = shapesSlice.actions;
